...
class Login():
    ...
    def login_hf(self):
       ...
       if self._input_argv == 'MachineInnovation':
           ...
           print(f"Ok puoi accedere")
           token = self.token
       else:
           print(f"Ko Attenzione non potrai accedere")
       ...
       try:
           ...
           print(f"Ok Accesso ad HuggingFace avvenuto con successo!")
           print(f"Utente connesso: {user_info['name']}")

       except Exception as e:
           print(f"Ko Errore di Accesso. Riprova con un nuovo token.")
           print(f"Dettagli: {e}")